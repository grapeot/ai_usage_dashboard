...
- Stacked token bar chart at y=92, height 200: 7 bars (7-day mode) or 30 bars (30-day mode), colored by provider (Cursor=white border, GLM=green, Gemini=striped white, Claude=red, GPT=yellow, DeepSeek=blue, Other=black)
